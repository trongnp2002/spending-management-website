...
public class LoginController {
    ...
    public String goToLoginPage(Model model) {
        ...
        if (SecurityUtils.getCurrentUsername() != null && SecurityUtils.getCurrentUsername().isEmpty()) {
    ...
    public String registerPost(Model model,
            @ModelAttribute("usersDTORegister") UsersDTORegisterRequest accountDTORegister) throws Exception {
