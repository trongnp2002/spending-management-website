...
public interface UsersRepository extends JpaRepository<Users, Integer> {
        ...
        // account-non-lock
        @Query(value = "SELECT * FROM users u WHERE u.email LIKE %?1% AND u.account_non_locked = ?2", nativeQuery = true)
        ...
        @Query(value = "SELECT * FROM users u WHERE u.phone LIKE %?1% AND u.account_non_locked = ?2", nativeQuery = true)
        ...
        @Query(value = "SELECT * FROM users u WHERE (u.first_name LIKE %?1% or last_name LIKE %?2%) AND u.account_non_locked = ?3", nativeQuery = true)
        ...
        @Query(value = "SELECT * FROM users u WHERE u.phone LIKE %?1% AND u.is_active = ?2", nativeQuery = true)
        ...
        @Query(value = "SELECT * FROM users u WHERE (u.first_name LIKE %?1% or last_name LIKE %?2%) AND u.is_active = ?3", nativeQuery = true)
