...
public interface UsersService {
   ...
   public String registerAccount(Model model, UsersDTORegisterRequest accountDTORegister) throws CustomBadRequestException, Exception;


   public void checkEmailCondition(HttpServletRequest request, HttpServletResponse response) throws IOException, CustomBadRequestException;
